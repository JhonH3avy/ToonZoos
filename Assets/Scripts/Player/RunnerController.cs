    ...
    private void ChangeState ()
    {
        switch ( nextState )
        {
            case CharacterState.Falling:
                if ( CurrentState == CharacterState.Running || CurrentState == CharacterState.Changing_Track
            ...
            case CharacterState.Running:
                if ( CurrentState == CharacterState.Ready || CurrentState == CharacterState.Jumping
                    || CurrentState == CharacterState.Falling || CurrentState == CharacterState.Changing_Track )
                    CurrentState = nextState;
                break;
